...
---
iDigBio has transitioned its web presence to this [Hosted Portal](./) powered by GBIF. Our legacy website and wiki at [www.idigbio.org](https://www.idigbio.org) will redirect here for the forseeable future. That said, access to the legacy [iDigBio data portal](https://portal.idigbio.org/) and the active [Symbiota network portals](https://symbiota.org/symbiota-portals/) are ***not affected*** by this transition.
