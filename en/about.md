...
<img src="{{ site.data.images.iDigBioStackedLogoCMYK.src }}" alt="{{ site.data.images.iDigBioStackedLogoCMYK.alt }}" title="{{ site.data.images.iDigBioStackedLogoCMYK.caption }}" style="margin: 1em 1em 1em 1em; float: right; width: 150px;">
