...
{% comment %} <!-- THE FOLLOWING CALENDAR IMPLEMENTATION IS RESERVED FOR FUTURE USE. IT IS DRIVEN BY THE .MD FILES IN THE _EVENTS FOLDER. -->
...
{% endcomment %}
{% comment %} <!-- THE .ICS FUNCTIONALITY IS CURRENTLY NOT WORKING. -->
<p style="font-size: smaller; text-align: center;">
