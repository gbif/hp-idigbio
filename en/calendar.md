...
<div id="calendar"></div>
<br><img src="{{ site.data.images.FeedIcon.src }}" alt="{{ site.data.images.FeedIcon.alt }}" title="{{ site.data.images.FeedIcon.caption }}" style="float: left; width: 35%; margin: 1em 1em 1em 1em; text-align: left; width: 100px; height: 100px;"> [Click here](/calendar/export.ics) to download and iCalendar feed of iDigBio's calendar.